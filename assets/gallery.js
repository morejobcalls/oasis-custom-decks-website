...
(function () {
  var tiles = Array.prototype.slice.call(document.querySelectorAll('.pg a'));
  ...
  tiles.forEach(function (a, n) { a.addEventListener('click', function (e) { e.preventDefault(); show(n); }); });
